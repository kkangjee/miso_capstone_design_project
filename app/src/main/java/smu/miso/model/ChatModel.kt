...
open class ChatModel {
    ...
    class Message(){
        @JvmField open var uid: String = ""
        @JvmField open var msg: String = ""
        @JvmField open var msgtype: String = ""
        @JvmField open var timestamp: Any = ""
        @JvmField open var readUsers: HashMap<String, Boolean> = HashMap()
    }
    class FileInfo {
